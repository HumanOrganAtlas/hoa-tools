...
#   timestamp: 2026-01-20T10:37:06+00:00
...
class Donor(BaseModel):
    ...
    date_of_death: Annotated[
        date_aliased | str | None, Field(title="Date of death")
    ] = None
...
class Proposal(BaseModel):
    proposal_number: Annotated[
        Literal["md1252", "md1290", "md1389", "md1373"],
...
class Sample(BaseModel):
    ...
    fixation_medium: Annotated[
        ...
        Field(description="Fixation medium", title="Fixation Medium"),
    ] = None
    ...
    degassing_method: Annotated[
        Literal["inline", "vacuum", "vacuum+inline", "not degassed"] | None,
        Field(title="Degassing Method"),
    ] = None
    scan_solvent: Annotated[
        Literal["formalin", "ethanol", "paraffin block"] | None,
    ...
    scan_temperature: Annotated[
        str | float | None,
        Field(
            description="Temperature during scan, in degrees celsius (if a number).",
...
class Scan(BaseModel):
    ...
    psho: Annotated[
        float | None,
        Field(
            description="Primary slit horizontal offset, measured in millimeters",
            title="Primary slit horizontal offset",
        ),
    ] = None
